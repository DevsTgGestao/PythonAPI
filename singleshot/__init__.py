...
cont_pg = 0
url_tg_plano_contas = f"{url_base}/{obj3}?{filtro}?cursor={cont_pg}" 
url_tg_contas_a_pagar = f"{url_base}/{obj2}?{filtro}?cursor={cont_pg}" 
url_tg_contas_a_receber = f"{url_base}/{obj1}?{filtro}?cursor={cont_pg}"
